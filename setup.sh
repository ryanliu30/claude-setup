...
# 4. plan-grill.sh forced the grilling skill in plan mode. Planning now offers it instead.
rm -f "$TARGET/hooks/plan-grill.sh"
rmdir "$TARGET/hooks" 2>/dev/null || true
