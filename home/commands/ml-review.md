...
has cloud and PR machinery this command does not; use this one when the diff touches models,
data pipelines, or training code. Detect the mode automatically:
